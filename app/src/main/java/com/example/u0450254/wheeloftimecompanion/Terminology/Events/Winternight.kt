...
class Winternight: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val string2 = SpannableString("The Winternight Attack\n\n")
        string2.setSpan(RelativeSizeSpan(2f), 0, 22, 0)

        val string3 = SpannableString("     In 998 NE, Winternight held special and tragic significance for the village of Emond's Field in the Two Rivers, when Trollocs and at least one Myrddraal attacked. " +
        ...
        val string3_1 = SpannableString("     In 998 NE, Winternight held special and tragic significance for the village of Emond's Field in the Two Rivers, when Trollocs and at least one Myrddraal attacked. " +
                "Their attack failed due both to the customs of Winternight in the Two River's area, and to the fortuitous presence of an Aes Sedai, Moiraine Damodred, and her Warder, Lan Mandragoran. " +
