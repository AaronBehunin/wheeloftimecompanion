...
class BelTine: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var string2 = SpannableString("     The night preceding Bel Tine is known as Winternight.\n\n")

        var string3 = SpannableString("     At noon on the day of Festival, unmarried women dance around the Spring Pole entwining it with ribbons while the unmarried men sing.\n\n")
