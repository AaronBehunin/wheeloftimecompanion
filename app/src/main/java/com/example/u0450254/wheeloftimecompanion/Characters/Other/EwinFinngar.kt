...
class EwinFinngar : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val string3 = SpannableString("     Ewin is a short, highly excitable pudgy-faced fourteen-year-old.\n\n")

        val string4 = SpannableString("Activities\n\n")
        string4.setSpan(RelativeSizeSpan(2f),0,10,0)

        val string5 = SpannableString("     On the day before Bel Tine in 998 NE, Ewin became enamored with a mysterious female visitor to the village who arrived with a male companion. He rushed to the cellar of the Winespring Inn in order to gossip about these strangers to Mat and Rand. Ewin was later gifted a silver penny from the visitor and decided not to spend it.\n\n")
        val string5_1 = SpannableString("     On the day before Bel Tine in 998 NE, Ewin became enamored with a mysterious female visitor to the village who arrived with a male companion. He rushed to the cellar of the Winespring Inn in order to gossip about these strangers to Mat and Rand. Ewin was later gifted a silver penny from the visitor and decided not to spend it. That same day when Padan Fain arrived in Emond's Field, Ewin interrupted Fain's storytelling about Logain Ablar and was nearly cuffed by Cenn Buie who wanted him to remain silent while elders were speaking.\n\n")
        ...
        {
            thisPortrat.setImageResource(R.drawable.ewin_finngar)
        }
