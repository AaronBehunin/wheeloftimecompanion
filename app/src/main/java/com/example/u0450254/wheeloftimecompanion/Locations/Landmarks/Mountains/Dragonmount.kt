...
class Dragonmount : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val string2 = SpannableString("      It was created during the Breaking of the World, when Lews Therin Telamon killed himself after Ishamael Healed him from the insanity caused by the taint on saidin. " +
        ...
        val string3 = SpannableString("     This eruption caused a river that had been flowing through the area near the mountain to fork, creating an isle.")
