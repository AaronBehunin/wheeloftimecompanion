...
class Thom : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var string3 = SpannableString("     He is fairly old, and has a gnarled face, shaggy white hair, and blue eyes. He is tall, with stooped shoulders. He wears a cloak that is described by Bran al'Vere as having more patches than cloak and more colors than you can think of. " +
        ...
        var string5 = SpannableString("     Not much of his early life is known.\n\n")

        var string7 = SpannableString("Activities\n\n")
        string7.setSpan(RelativeSizeSpan(2f),0,10,0)

        var string8 = SpannableString("Escape from the Two Rivers\n\n")
        string8.setSpan(RelativeSizeSpan(1.5f),0,26,0)

        var string9 = SpannableString("     With his Bardic talents giving him more than the requisite skills, he became a gleeman and journeyed across the land, performing in inns and villages, sometimes for pay, sometimes just for supper and a bed. He just so happened to arrive in Emond's Field late on the same night Moiraine Damodred arrived.\n\n")
        var string9_1 = SpannableString("     With his Bardic talents giving him more than the requisite skills, he became a gleeman and journeyed across the land, performing in inns and villages, sometimes for pay, sometimes just for supper and a bed. He just so happened to arrive in Emond's Field late on the same night Moiraine Damodred arrived, and was present on the very next night when Trollocs attacked.\n\n")
        var string9_2 = SpannableString("     With his Bardic talents giving him more than the requisite skills, he became a gleeman and journeyed across the land, performing in inns and villages, sometimes for pay, sometimes just for supper and a bed. He just so happened to arrive in Emond's Field late on the same night Moiraine Damodred arrived, and was present on the very next night when Trollocs attacked. After the four young people decided to leave for Tar Valon with Moiraine who by then had revealed herself as Aes Sedai, he went with Rand al'Thor, Mat Cauthon, Perrin Aybara, and Egwene al'Vere.\n\n")
