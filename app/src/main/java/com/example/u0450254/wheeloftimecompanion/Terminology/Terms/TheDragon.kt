...
class TheDragon: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val string3 = SpannableString("The Dragon Reborn\n\n")
        string3.setSpan(RelativeSizeSpan(2f), 0, 17, 0)

        val string4 = SpannableString("     The reincarnation of Lews Therin as the Dragon Reborn, is fated to both destroy and save the world. Prophecy says that he would break all bonds and bring suffering to the earth. It is commonly expected that in doing so he will also bring a new Breaking of the World. Due to Lews Therin Telamon's infamy, for better or for worse, the tale of the Dragon Reborn is known well even in remote villages.\n\n")

        val string6 = SpannableString("False Dragons\n\n")
        string6.setSpan(RelativeSizeSpan(2f), 0, 13, 0)

        val string7 = SpannableString("     Men who have declared themselves to be the Dragon Reborn but do not fulfill any prophecy are said to be false Dragons. This is often done for fame or glory, but in the end all have fallen from power.\n\n")
