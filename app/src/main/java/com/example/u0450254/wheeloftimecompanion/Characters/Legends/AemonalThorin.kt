...
class AemonalThorin : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var string1_1 = SpannableString("\n     Aemon al Caar al Thorin (translated from the Old Tongue as Aemon, son of Caar, son of Thorin) was the husband of Eldrene ay Ellan ay Carlan and the last King of lost Manetheren. He was a warrior of exceptional ability and a revered ruler of his people. His father was Caar al Thorin al Toren.")

        var string2 = SpannableString("Appearance and Abilities\n\n")
        string2.setSpan(RelativeSizeSpan(2f),0,24,0)

        var string3 = SpannableString("     Aemon was renowned throughout the Ten Nations for his unmatched courage. Aemon's greatest love - his wife Queen Eldrene - was a beloved figurehead of their people. Together they represented bravery and beauty and wisdom and a love that death could not sunder.\n\n")

        var string4 = SpannableString("History\n\n")
        string4.setSpan(RelativeSizeSpan(2f),0,7,0)

        var string8 = SpannableString("The Trolloc Wars\n\n")
        string8.setSpan(RelativeSizeSpan(1.5f),0,16,0)

        var string9 = SpannableString("     Wherever men fought the forces of the Dark One, the Red Eagle of Manetheren was always at the fore. For their perseverance and courage, the Army of Manetheren became known as a thorn to the Dark one's foot, and a bramble to his hand and Manetheren itself as the sword that could not be broken.\n\n")

        var string11 = SpannableString("     Despite the one-sided slaughter that Aemon's soldiers had visited upon their enemy, he had overextended his military forces, providing an opportunity for Shadowspawn armies to assault the very heartland of Manetheren.\n\n")

        var string12 = SpannableString("The Fall of Manetheren\n\n")
        ...
        {
            thisInfo.text = TextUtils.concat(string1,string2,string3,string4,string8,string9,string11,string12,string13,string14,string15,string16,string17,string24)
        }
    }
}