...
class Manetherendrelle : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var string2 = SpannableString("    The Manetherendrelle itself rises in the Mountains of Mist at the extreme south-western tip of the Two Rivers district of Andor. " +
        ...
        var string3 = SpannableString("     The Tarendrelle joins the Manetherendrelle further east before it is also joined by the Arinelle some distance south of Whitebridge. " +
        ...
        var string4 = SpannableString("     Between the Manetherendrelle and Arinelle, it is possible to sail from Maradon, the capital of Saldaea, all the way to Illian, a distance of approximately three thousand miles.\n\n")
