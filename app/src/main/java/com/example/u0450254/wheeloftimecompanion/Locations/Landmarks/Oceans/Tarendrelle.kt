...
class Tarendrelle: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val string3 = SpannableString("     The river begins at the roots of the Mountains of Mist where it is fed by upstream tributaries. " +
        ...
        val string5 = SpannableString("     In the middle years of the Trolloc Wars, two bridges spanning the Tarendrelle River played a major role during the final defense of Manetheren at the Battle of the Tarendrelle River. " +
