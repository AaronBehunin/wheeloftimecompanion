...
class TamAlThor : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var string3 = SpannableString("     He has a thick chest and a lined face. His hair is gray with sprinkles of black. He is described as being solid in virtually every conceivable way.\n\n")

        var string5 = SpannableString("History\n\n")
        string5.setSpan(RelativeSizeSpan(2f),0,7,0)

        var string8 = SpannableString("     He returned to the Two Rivers with his wife and the baby, whom he named Rand. There he settled on an outlying farm.\n\n")

        var string9 = SpannableString("     Kari al'Thor died before she could see her son grow up, and Tam never remarried, despite the best efforts of the Women's Circle.\n\n")

        var string10 = SpannableString("     During Rand's childhood, Tam taught him the trick of \"the flame and the void\". The technique, though meditative in nature and not combat oriented, helped Rand to improve his archery skills." +
        ...
        {
            thisInfo.text = TextUtils.concat(thisInfo.text,string14)
        }
        ...
        {
            thisInfo.text = TextUtils.concat(thisInfo.text,string15,string16)
        }
        if (progress.book>1||progress.book==1&&progress.chapter>6)
        {
            thisInfo.text = TextUtils.concat(thisInfo.text,string17)
        }
        ...
        {
            thisInfo.text = TextUtils.concat(thisInfo.text,string19)
        }
    }
}
