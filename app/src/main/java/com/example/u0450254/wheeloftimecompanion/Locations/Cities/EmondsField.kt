...
class EmondsField : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var string31 = SpannableString("     In addition to these commodities, the economy of Emond's Field also depends on the tradecraft of mill owner Jon Thane and thatcher Cenn Buie. The Mayor and his wife Marin al'Vere also enjoy occasional business as owners of the Winespring Inn.\n\n")
        var string31_1 = SpannableString("     In addition to these commodities, the economy of Emond's Field also depends on the tradecraft of blacksmith Haral Luhhan, mill owner Jon Thane, and thatcher Cenn Buie. The Mayor and his wife Marin al'Vere also enjoy occasional business as owners of the Winespring Inn.\n\n")

        var string32 = SpannableString("Recent EventsActivity\n\n")
        string32.setSpan(RelativeSizeSpan(2f), 0,13,0)

        var string33 = SpannableString("     For as long as anyone can remember Emond's Field has been a peaceful, isolated village, but recent events have led to dramatic changes.\n\n")

        var string34 = SpannableString("Winternight\n\n")
        string34.setSpan(RelativeSizeSpan(1.5f), 0,11,0)

        var string35 = SpannableString("     On Winternight of the year 998 NE, a force of about one hundred Trollocs raided Emond's Field. As a result a few people were killed, several more were wounded, and many buildings were damaged. Fortunately the Aes Sedai Moiraine Damodred and her Warder interceded and prevented more violence.\n\n")
        var string35_1 = SpannableString("     On Winternight of the year 998 NE, a force of about one hundred Trollocs raided Emond's Field. As a result a few people were killed, several more were wounded, and many buildings were damaged. Fortunately the Aes Sedai Moiraine Damodred and her Warder interceded and prevented more violence.  After these events, the Aes Sedai left with four young villagers (Rand al'Thor, Matrim Cauthon, Perrin Aybara, and Egwene al'Vere) and a gleeman named Thom Merrilin.\n\n")
        ...
        {
            thisInfo.text = TextUtils.concat(thisInfo.text,string32,string33,string34,string35)
        }
