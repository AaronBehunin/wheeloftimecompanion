...
class Activity7E: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val view4 = inflatedLayoutLews.findViewById<RelativeLayout>(R.id.MoiraineView)
        val view5 = inflatedLayoutLews.findViewById<RelativeLayout>(R.id.LanView)
        val view6 = inflatedLayoutLews.findViewById<RelativeLayout>(R.id.ThomView)
        val view7 = inflatedLayoutLews.findViewById<RelativeLayout>(R.id.TamAlThorView)
