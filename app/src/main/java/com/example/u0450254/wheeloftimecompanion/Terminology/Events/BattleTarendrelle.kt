...
class BattleTarendrelle: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val string1_1 = SpannableString("The Battle of the Tarendrelle River was a conflict that occurred in the middle years of the Trolloc Wars between the nation of Manetheren and a vast host of Shadowspawn. " +
                "It resulted in a victory for the forces of Shadow and led to the subsequent invasion and destruction of Manetheren.\n\n")

        val string2 = SpannableString("Background\n\n")
        string2.setSpan(RelativeSizeSpan(2f),0,10,0)

        val string3 = SpannableString("     Two centuries of conflict saw many heated battles between the armies of shadow and the forces of Light. " +
        ...
        val string4 = SpannableString("     In the middle years of the Trolloc Wars, circa 1200 AB, Manetheren was ruled by King Aemon al Caar al Thorin and his queen Eldrene ay Ellan ay Carlan. " +
        ...
        val string5 = SpannableString("     King Aemon's final victory occurred many leagues from his national borders upon the Field of Bekkar, known forever afterward as the Field of Blood.\n\n")

        val string6 = SpannableString("Prelude to Battle\n\n")
        string6.setSpan(RelativeSizeSpan(2f),0,17,0)

        val string7 = SpannableString("     Aemon immediately saw the peril Manetheren faced when the Shadow's plans were made known to him. Without hesitation or thought for the distance they must travel, the king's army marched from Bekkar, still covered in dust and sweat and blood. " +
        ...
        val string8 = SpannableString("Deployemnt and dispotision of forces\n\n")
        string8.setSpan(RelativeSizeSpan(2f),0,36,0)

        val string9 = SpannableString("The forces of the Shadow.\n\n")
        string9.setSpan(RelativeSizeSpan(1.5f),0,24,0)

        val string10 = SpannableString("     Histories researched by Moiraine Damodred relate that the armies of shadow counted in the \"tens of tens of thousands\" and were surrounded by a sky \"blackened with ravens\".\n\n")
        terminfo.setTextColor(Color.WHITE)

        val string12 = SpannableString("The forces of the Light\n\n")
        string12.setSpan(RelativeSizeSpan(1.5f),0,23,0)

        val string13 = SpannableString("     Impressively, the king himself was present on the battlefield. " +
        ...
        val string18 = SpannableString("The Battle\n\n")
        string18.setSpan(RelativeSizeSpan(2f),0,10,0)

        val string19 = SpannableString("     King Aemon arranged his troops in a defensive position blocking the bridges. The battle began that morning.\n\n")

        val string20 = SpannableString("Days one to three\n\n")
        string20.setSpan(RelativeSizeSpan(1.5f),0,17,0)

        val string21 = SpannableString("     Historical accounts of the battle relate that both armies felt at first that the forces of shadow would overwhelm the army of Manetheren. " +
        ...
        val string22 = SpannableString("Days four through nine\n\n")
        string22.setSpan(RelativeSizeSpan(1.5f),0,22,0)

        val string23 = SpannableString("     By the fourth day of battle Aemon began to suspect that no aid was coming. " +
        ...
        val string24 = SpannableString("Day ten\n\n")
        string24.setSpan(RelativeSizeSpan(1.5f),0,7,0)

        val string25 = SpannableString("      On the dark of morning on the tenth day the Army of Manetheren completed its withdrawal across the bridges before destroying them.\n\n")


        val string26 = SpannableString("Days eleven - conclusion\n\n")
        string26.setSpan(RelativeSizeSpan(1.5f),0,24,0)

        val string27 = SpannableString("     History records that civilians - who had ignored their king's order to flee - began to arrive on the battlefield. " +
        ...
        val string30 = SpannableString("Legacy\n\n")
        string30.setSpan(RelativeSizeSpan(2f),0,6,0)

        val string31 = SpannableString("     The Battle of the Tarendrelle River left a lasting impression upon those who would later return to populate Manetheren. " +
        ...
        {
            thisImage.setImageResource(R.drawable.battle_tarendrelle)
        }
