...
class BranAlVere : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val string3 = SpannableString("     With sparse gray hair and a round face, he has the look of many innkeepers: wearing an apron that strains over his wide girth. Surprisingly, he walks lightly for a man of his size. On special occasions, he wears a silver medallion of scales, the symbol of the office of Mayor.\n\n")

        val string4 = SpannableString("History\n\n")
        string4.setSpan(RelativeSizeSpan(2f),0,7,0)

        val string5 = SpannableString("     As the village Mayor and the head of the Village Council, people are always taking their problems to Bran for solving. He is also the owner of the Winespring Inn, which he runs with the help of his wife, Marin. The cellar of the inn contains many barrels of brandy and ale made by Bran, and sometimes apple cider or apple brandy made by Tam al'Thor, and delivered every year about Bel Tine.\n\n")
        thisInfo.setMovementMethod(LinkMovementMethod.getInstance());

        val string6 = SpannableString("Activities\n\n")
        string6.setSpan(RelativeSizeSpan(2f),0,10,0)

        val string7 = SpannableString("     He is part of the Village council.\n\n")
        val string7_2 =SpannableString("     He is part of the Village council, which is in session when Padan Fain arrives.\n\n")
