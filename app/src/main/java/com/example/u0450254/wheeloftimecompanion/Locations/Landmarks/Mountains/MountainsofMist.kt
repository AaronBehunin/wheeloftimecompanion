...
class MountainsofMist: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val string5 = SpannableString("The Breaking of the World\n\n")
        string5.setSpan(RelativeSizeSpan(1.5f), 0, 25, 0)

        val string6 = SpannableString("     Evidence suggests that the Mountains of Mist did not exist during the Age of Legends, when the area was covered by the shallows of a great ocean.\n\n")
        val string6_1 = SpannableString("     Evidence suggests that the Mountains of Mist did not exist during the Age of Legends, when the area was covered by the shallows of a great ocean. During the Breaking of the World, insane male Channelers raised the mountain range and drove back the sea. The disturbance of the adjacent shoreline would become the sand hills, and the rocks, ores, and minerals locked below the ocean floor were forced into enormous vertical displacements forging vast crags and peaks.\n\n")

        val string7 = SpannableString("Manetheren\n\n")
