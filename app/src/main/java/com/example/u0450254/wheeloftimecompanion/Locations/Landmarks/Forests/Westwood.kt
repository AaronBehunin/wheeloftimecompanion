...
class Westwood : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        {
            thisImage.setImageResource(R.drawable.westwood)
        }
