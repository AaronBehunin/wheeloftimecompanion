...
class TheOnePower: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var string35 = SpannableString("Organizations\n\n")
        string35.setSpan(RelativeSizeSpan(2f), 0, 13, 0)

        var string36 = SpannableString("     Aes Sedai was a term that was once used to describe both male and female channelers during the Age of Legends.\n\n")

        var string43 = SpannableString("The taint on saidin\n\n")
        string43.setSpan(RelativeSizeSpan(2f), 0, 19, 0)

        var string44 = SpannableString("     In the current age, the Dark One's taint on saidin causes male channelers, even those who survive the struggle to learn to channel safely, to inevitably go mad. " +
        ...
        var string45 = SpannableString("     Within ten years, enough men had gone mad. The ensuing chaos and destruction caused the Breaking of the World or the Time of Madness.\n\n")
