...
class Activity1E: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val view10 = inflatedLayoutLews.findViewById<RelativeLayout>(R.id.WestwoodView)
        ...
        val view13 = inflatedLayoutLews.findViewById<RelativeLayout>(R.id.ScalesofOfficeView)
        val view14 = inflatedLayoutLews.findViewById<RelativeLayout>(R.id.VoidView)
        val view15 = inflatedLayoutLews.findViewById<RelativeLayout>(R.id.ThirdAgeView)
        val view16 = inflatedLayoutLews.findViewById<RelativeLayout>(R.id.BelaView)
