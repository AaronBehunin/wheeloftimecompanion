...
class TheBreakingoftheWorld: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var string6 = SpannableString("During the Breaking\n\n")
        string6.setSpan(RelativeSizeSpan(2f),0,19,0)

        var string7 = SpannableString("     In their insanity, the male Aes Sedai used the One Power to destroy mountains and raise new ones, to drain oceans and flood dry land. Cities were wiped out and civilization completely collapsed during this time, only re-establishing itself in primitive form after the last of the male Aes Sedai were dead.\n\n")

        var string19 = SpannableString("After the Breaking\n\n")
        string19.setSpan(RelativeSizeSpan(2f),0,18,0)

        var string21 = SpannableString("     Much of the world was completely changed, and most of the world's population died in the upheaval. The glorious civilization of the Age of Legends had disappeared in three hundred years of blood and fire.\n\n")
