...
class VillageCouncil: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var string2 = SpannableString("     Village councilors establish economic policy with merchants, peddlers, and the councils of other communities. The primary function of the Mayor in this regard is to ensure a fair marketplace for all participants transacting within a village's sphere of influence.\n\n")
                terminfo.setTextColor(Color.WHITE)

        var string2_2 = SpannableString("     Village councilors establish economic policy with merchants, peddlers, and the councils of other communities. The primary function of the Mayor in this regard is to ensure a fair marketplace for all participants transacting within a village's sphere of influence. " +
        ...
        var string3 = SpannableString("     The power of the Village Council in each community is balanced by - and often at odds with -the equally important Women's Circle.  Each Circle is headed by a Wisdom who serves for life.\n\n")
