...
class TheTwoRivers : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var string3 = SpannableString("     The Two Rivers is a geographically insulated region in western Andor. The Mountains of Mist stretch along its western limits and in addition to the two major rivers that form its northern and southern boundaries, a treacherous fen known as The Mire blocks travelers who might approach from the east. Just to the west of The Mire is a large forest known as the Waterwood which serves as drainage for the Winespring Water flowing from Edmond's Field. West of the village communities is a dense forest known as the Westwood which extends along the western edge of the district next to the Sand Hills - a geographic anomaly near the foothills of the mountains.\n\n")
        ...
        var string6 = SpannableString("     When the Trolloc Wars began circa 1000 AB, Manetheren for years fought valiantly to repulse invasions of Shadowspawn aimed at its allies. For this Manetheren became known as a \"Thorn to the Dark One's foot and a bramble to his hand\" " +
        ...
        var string8 = SpannableString("Government\n\n")
        string8.setSpan(RelativeSizeSpan(2f), 0, 10, 0)

        var string9 = SpannableString("     All communities in the Two Rivers practice a form of gender-based bicameral government. In each village governance is officially controlled by a Village Council consisting entirely of men. Each council is headed by a mayor. " +
        ...
        var string10 = SpannableString("Culture\n\n")
        ...
        var string12 = SpannableString("Economics and Trade\n\n")
