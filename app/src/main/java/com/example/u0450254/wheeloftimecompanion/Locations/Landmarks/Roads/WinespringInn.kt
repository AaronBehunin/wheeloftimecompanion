...
class WinespringInn: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val string2 = SpannableString("     The first floor of the inn is constructed of river rock, though built upon a foundation of much older stone quarried from the Mountains of Mist. " +
        ...
        val string2_2 = SpannableString("     The first floor of the inn is constructed of river rock, though built upon a foundation of much older stone quarried from the Mountains of Mist. " +
        ...
        val string3 = SpannableString("     The second floor is whitewashed and extends out over the lower floor for the entire perimeter. The structure has a dozen chimneys and a red tiled roof that was the first non-thatched covering in Emond's Field. " +
                "Bran al'Vere lives with his family at the back of the second floor.\n\n")

        val string4 = SpannableString("     The Winespring Inn serves as the meeting place for the Village Council. Along with the village green, it is a primary focal point during annual Bel Tine festivals.\n\n")
