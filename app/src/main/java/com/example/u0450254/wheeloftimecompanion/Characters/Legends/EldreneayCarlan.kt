...
class EldreneayCarlan : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var string3 = SpannableString("     Historians relate that Eldrene possessed a great beauty. It was said that wherever she went, flowers bloomed at her feet to make her smile.\n\n")

        var string4 = SpannableString("History\n\n")
        string4.setSpan(RelativeSizeSpan(2f),0,7,0)

        var string7 = SpannableString("Trolloc Wars\n\n")
